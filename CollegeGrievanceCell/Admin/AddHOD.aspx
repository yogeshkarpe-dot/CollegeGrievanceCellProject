<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddHOD.aspx.cs" Inherits="CollegeGrievanceCell.Admin.AddHOD" %>
    ...
    <form id="form1" runat="server">
        <div style="position:absolute ; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 20px; background-color: aquamarine; border: 1px solid black;">
            <h1 style="color: mediumpurple; text-align: center">
                <%Response.Write(Session["title"]);%> HOD
            </h1>

            <div style="float: left; margin-bottom: 10px">
                <asp:HyperLink ID="LinkBack" NavigateUrl="~/Admin/HODs.aspx" Width="200px" Font-Size="Larger" runat="server">< Back</asp:HyperLink>
            </div>
            ...
            <table>
                <tr style="padding:20px 0">
                    ...
                    <td>
                        <asp:TextBox ID="txtHODId" runat="server" Width="400px" Height="20px" required></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0 10px">
