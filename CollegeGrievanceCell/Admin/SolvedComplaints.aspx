<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolvedComplaints.aspx.cs" Inherits="CollegeGrievanceCell.Admin.SolvedComplaints" %>
...
<body style="background-color: lightpink; display: flex; justify-content: center; align-items: center; margin: 40px">
    <form id="form1" runat="server">
        <div style="background-color: aquamarine; width: 1300px; height: 635px; border: 1px solid black ; padding: 0 50px">
           <h1 style="text-align: center">Solved Complaints</h1>
            ...
            <div style="margin-top:20px">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CS %>" SelectCommand="SELECT * FROM [Complaints] WHERE Status='Solved' ORDER BY ComplaintDate DESC"></asp:SqlDataSource>
            </div>
