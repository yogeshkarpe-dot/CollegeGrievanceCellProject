<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentHome.aspx.cs" Inherits="CollegeGrievanceCell.Student.StudentHome" %>
    ...
    <form id="form1" runat="server" >
        <div style="position:absolute ; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 10px; background-color: aquamarine; border: 1px solid black;">
            <div style="margin-bottom: 10px">
                <asp:HyperLink ID="LinkBack" NavigateUrl="~/Student/StudentLogin.aspx" Width="200px" Font-Size="Larger" runat="server">< Back</asp:HyperLink>
            </div>
            <div style="padding: 20px 0">
                ...
                <span>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Student/RaiseComplaint.aspx" Font-Size="XX-Large" ForeColor="DarkRed"> Raise a Complaint</asp:HyperLink>
                </span>
            </div>
