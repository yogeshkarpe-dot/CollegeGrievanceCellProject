<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HODHome.aspx.cs" Inherits="CollegeGrievanceCell.Student.HODHome" %>
    ...
    <form id="form1" runat="server" >
        <div style="position:absolute ; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 10px; background-color: aquamarine; border: 1px solid black;">
            <div style="margin-bottom: 10px">
                <asp:HyperLink ID="LinkBack" NavigateUrl="~/HOD/HODLogin.aspx" Width="200px" Font-Size="Larger" runat="server">< Back</asp:HyperLink>
            </div>
