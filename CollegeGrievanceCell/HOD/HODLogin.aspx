<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HODLogin.aspx.cs" Inherits="CollegeGrievanceCell.HOD.HODLogin" %>
        ...
        <div style="position:absolute ; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 30px; background-color: aquamarine; border: 1px solid black;">
            ...
            <table>
                <tr style="padding:20px 0">
                    ...
                    <td>
                        <asp:TextBox ID="txtHODId" runat="server" Width="200px" Height="20px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0 10px">
