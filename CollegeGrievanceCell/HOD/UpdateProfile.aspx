<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProfile.aspx.cs" Inherits="CollegeGrievanceCell.HOD.UpdateProfile" %>
    ...
    <form id="form1" runat="server">
        <div style="position:absolute ; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 20px; background-color: aquamarine; border: 1px solid black;">
            ...
            <div style="float: left; margin-bottom: 10px">
                <asp:HyperLink ID="LinkBack" NavigateUrl="~/HOD/HODHome.aspx" Width="200px" Font-Size="Larger" runat="server">< Back</asp:HyperLink>
            </div>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtHODId" ReadOnly="true" runat="server" Width="400px" Height="20px" required></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0 10px">
